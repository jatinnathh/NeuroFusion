...
import ipConfig from './ip.json'; // or ./ip.json or ../screens/ip.json depending on location
  ...
  try {
    ...
    if (!resp.ok) {
      if (resp.status === 401) {
        Alert.alert(
          'Account Not Found',
          'No account found with this email/password.',
          [
  ...
  return (
    ...
    >
      ...
      <View style={styles.inner}>
        <Text style={styles.logo}>NeuroFusion</Text>
