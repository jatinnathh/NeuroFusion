...
# Load backend URL from ip.json (used by React Native app to know this server's IP)
with open(ip_path, "r") as f:
    backendURL = json.load(f)["ip"]

print(f"[backend] HF Space inference URL: {HF_SPACE_URL}")
...
async def process_queue():
    while True:
        ...
        try:
            ...
            has_input_image = bool(job["input_image"])
